...
$routes->get('/practice/questions/(:num)', 'Home::questions/$1');

   $routes->get('books', 'Home::book'); 
   $routes->get('book-details/(:any)', 'Home::book_details/$1');
    $routes->get('winners-member', 'Home::winners_member'); 
   
     $routes->get('competitions', 'Home::competitions'); 
   
   $routes->get('olympiad-result', 'Olympiad_result::index');
$routes->post('olympiad-result/search', 'Olympiad_result::search');

$routes->post('newsletter/subscribe', 'Home::subscribe');
   $routes->post('book/save-enquiry', 'Home::save_enquiry');
   
   // app/Config/Routes.php
$routes->get('talent-winners', 'Home::talent_winners');
$routes->get('/gallery', 'Home::gallery');
$routes->get('/olympiads', 'Home::olympiads');
$routes->get('/competition-details/(:num)', 'Home::competition_details/$1');


$routes->get('/list-of-workshops', 'Home::list_of_workshops');
...
$routes->get('/departments/(:any)', 'Home::product_details/$1');
...
$routes->get('/post', 'Home::post');
  ...
  $routes->post('posts/create', 'PostController::createPost');
    $routes->post('posts/addComment', 'PostController::addComment');
    $routes->get('posts/getComments/(:num)', 'PostController::getPostComments/$1');
    $routes->post('posts/addReaction', 'PostController::addReaction');
    $routes->get('posts/getPosts/(:num)', 'PostController::getPosts/$1');
    $routes->get('posts/deletePost/(:num)', 'PostController::deletePost/$1');
    $routes->get('posts/getUserProfile/(:num)', 'PostController::getUserProfile/$1');
    
    
    

$routes->get('/medical-leadership-workshops', 'Home::medical_leadership_workshops');

 $routes->get('/resource', 'Home::resources');
...
$routes->post('verify_payment', 'Home::verify_payment');
$routes->get('registration-success', 'Home::registration_success');
...
$routes->get('/talks', 'Home::talks');
$routes->get('/video-podcast', 'Home::video_podcast');
$routes->get('/podcast', 'Home::podcast');
$routes->get('/free-resources', 'Home::free_resources');
$routes->get('/medical-astrology', 'Home::medical_astrology');
...
$routes->get('/page/(:any)', 'Home::pages/$1');
        ...
        $routes->get('admin/books', 'Book::book');                           // Main page
    $routes->post('admin/book-list', 'Book::book_list');                 // DataTable AJAX
    $routes->post('admin/book_save', 'Book::book_save');                 // Save new book
    $routes->post('admin/book_update', 'Book::book_update');             // Update book
    $routes->post('admin/book_delete', 'Book::book_delete'); 
    
    
     $routes->get('admin/enquiry', 'Enquiry::enquiry');
    $routes->post('admin/enquiry-list', 'Enquiry::enquiry_list');
    $routes->post('admin/enquiry-update-status', 'Enquiry::update_status');
    $routes->post('admin/enquiry-delete', 'Enquiry::delete_enquiry');
    $routes->post('admin/enquiry-get', 'Enquiry::get_enquiry');
    
      $routes->get('admin/winners-member', 'Winners_member::winners_member');
    $routes->post('admin/winners-member-list', 'Winners_member::winners_member_list');
    $routes->post('admin/winner-member-save', 'Winners_member::winner_member_save');
    $routes->post('admin/winner-member-update', 'Winners_member::winner_member_update');
    $routes->post('admin/winner-member-delete', 'Winners_member::winner_member_delete');
    
    
     $routes->get('admin/talent-winners', 'Talent_winners::talent_winners');
    $routes->post('admin/talent-winners-list', 'Talent_winners::talent_winners_list');
    $routes->post('admin/talent-winner-save', 'Talent_winners::talent_winner_save');
    $routes->post('admin/talent-winner-update', 'Talent_winners::talent_winner_update');
    $routes->post('admin/talent-winner-delete', 'Talent_winners::talent_winner_delete');
    

    // Olympiad Results Routes
$routes->get('admin/olympiad-results', 'Olympiad_results::olympiad_results');
$routes->post('admin/olympiad-results-list', 'Olympiad_results::olympiad_results_list');
$routes->post('admin/olympiad-result-save', 'Olympiad_results::olympiad_result_save');
$routes->post('admin/olympiad-result-update', 'Olympiad_results::olympiad_result_update');
$routes->post('admin/olympiad-result-delete', 'Olympiad_results::olympiad_result_delete');

// CSV Import/Export Routes
$routes->post('admin/csv-import', 'Olympiad_results::csv_import');
$routes->get('admin/csv-export', 'Olympiad_results::csv_export');
$routes->get('admin/download-sample-csv', 'Olympiad_results::download_sample_csv');

// Subject Routes
$routes->get('admin/get-subjects', 'Olympiad_results::get_subjects');
$routes->post('admin/subject-save', 'Olympiad_results::subject_save');
$routes->post('admin/subject-update', 'Olympiad_results::subject_update');
$routes->post('admin/subject-delete', 'Olympiad_results::subject_delete');
$routes->get('admin/subject-list', 'Olympiad_results::subject_list');

// Class Routes
$routes->get('admin/get-classes', 'Olympiad_results::get_classes');
$routes->post('admin/class-save', 'Olympiad_results::class_save');
$routes->post('admin/class-update', 'Olympiad_results::class_update');
$routes->post('admin/class-delete', 'Olympiad_results::class_delete');
$routes->get('admin/class-list', 'Olympiad_results::class_list');
    
    
    // Admin routes for activity logs
$routes->get('admin/activity-logs', 'Admin::activity_logs');
$routes->get('admin/view-log-detail/(:num)', 'Admin::view_log_detail/$1');
$routes->get('admin/delete-log/(:num)', 'Admin::delete_log/$1');
$routes->get('admin/clear-all-logs', 'Admin::clear_all_logs');
$routes->get('admin/export-logs', 'Admin::export_logs');


 $routes->get('admin/teachers', 'Teacher::index');
    $routes->post('admin/teacher-list', 'Teacher::teacher_list');
    $routes->post('admin/teacher_save', 'Teacher::teacher_save');
    $routes->post('admin/teacher_update', 'Teacher::teacher_update');
    $routes->post('admin/teacher_delete', 'Teacher::teacher_delete');
    

 $routes->get('admin/competition-registrations', 'CompetitionRegistrations::index');
    
    // DataTable AJAX
    $routes->post('admin/competition-registrations-list', 'CompetitionRegistrations::competition_registrations_list');
    
    
    // Students Routes
$routes->get('admin/students', 'Students::index');
$routes->post('admin/students-list', 'Students::students_list');
$routes->get('admin/csv-export', 'Students::csv_export');
$routes->post('admin/csv-export-filtered', 'Students::csv_export_filtered');
$routes->get('admin/view-student/(:num)', 'Students::view_student/$1');
    


$routes->get('admin/syllabus', 'Syllabus::index');

// DataTable AJAX Routes
$routes->post('admin/syllabus-list', 'Syllabus::syllabus_list');

// Syllabus CRUD
$routes->post('admin/syllabus_save', 'Syllabus::syllabus_save');
$routes->post('admin/syllabus_update', 'Syllabus::syllabus_update');
$routes->post('admin/syllabus_delete', 'Syllabus::syllabus_delete');

// Questions Routes
$routes->post('admin/get_questions', 'Syllabus::get_questions');
$routes->post('admin/add_question', 'Syllabus::add_question');
$routes->post('admin/update_question', 'Syllabus::update_question');
$routes->post('admin/delete_question', 'Syllabus::delete_question');

// Optional: For viewing PDF directly
$routes->get('admin/view-pdf/(:any)', 'Syllabus::view_pdf/$1');

$routes->get('admin/competitions', 'CompetitionController::index',['filter' => 'authGuard']);
$routes->post('admin/competition_list', 'CompetitionController::competition_list',['filter' => 'authGuard']);
$routes->post('admin/add_competition', 'CompetitionController::add_competition',['filter' => 'authGuard']);
$routes->post('admin/update_competition', 'CompetitionController::update_competition',['filter' => 'authGuard']);
$routes->post('admin/delete_competition', 'CompetitionController::delete_competition',['filter' => 'authGuard']);
$routes->post('admin/get_competition_data', 'CompetitionController::get_competition_data',['filter' => 'authGuard']);


// Olympiad Routes
$routes->get('admin/olympiads', 'OlympiadController::index',['filter' => 'authGuard']);
$routes->post('admin/olympiad_list', 'OlympiadController::olympiad_list',['filter' => 'authGuard']);
$routes->post('admin/add_olympiad', 'OlympiadController::add_olympiad',['filter' => 'authGuard']);
$routes->post('admin/update_olympiad', 'OlympiadController::update_olympiad',['filter' => 'authGuard']);
$routes->post('admin/delete_olympiad', 'OlympiadController::delete_olympiad',['filter' => 'authGuard']);
...
$routes->get('/buy-plan/(:num)', 'PaymentController::buyplan/$1');
$routes->post('razorpay-callback/(:num)', 'PaymentController::razorpayCallback/$1');
 ...
 */
 ...
 $routes->get('/cart', 'Home::cart');
  $routes->get('/checkout', 'Home::checkout',['filter' => 'AuthFrontGuard']);
   $routes->get('/wishlist', 'Home::wishlist',['filter' => 'AuthFrontGuard']);
   $routes->get('/store', 'Home::store');
  $routes->get('/store/(:any)', 'Home::catalog/$1');
...
$routes->post('update-password', 'Dashboard::update_password',['filter' => 'AuthFrontGuard']);
...
// Admin Routes
$routes->get('admin/exotic', 'Exotic::index');
$routes->post('admin/exotic-list', 'Exotic::exotic_list');
$routes->post('admin/exotic_save', 'Exotic::exotic_save');
$routes->post('admin/exotic_update', 'Exotic::exotic_update');
$routes->post('admin/exotic_delete', 'Exotic::exotic_delete');
$routes->post('admin/exotic_get_gallery_images', 'Exotic::exotic_get_gallery_images');
$routes->post('admin/exotic_delete_gallery_image', 'Exotic::exotic_delete_gallery_image');
...
$routes->post('/getcategorypro', 'Ajex::getCategorypro');
