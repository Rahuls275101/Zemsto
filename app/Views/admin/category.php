					...
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							...
							<p class="breadcrumbs"><span><a href="index.html">Home</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>All Category > <?php echo $table_name;?>
							</p>
						</div>

						<div>
						
							<a href="javascript:void(0);" class="btn btn-primary" id="RecordCategory" data-toggle="modal" >Add category</a>
							    <?php if(!empty($back)) { ?>
...
<div class="col-md-12" > 
               <div class="form-group">
                  ...
                  <div class="form-group">
                  <label for="exampleInputEmail1">Slug</label>
                  <input type="text" class="form-control" name="url_slug" id="edit_url_slug">
                  </div>
                  </div>
                  <div class="col-md-12">
                  <div class="form-group">
...
$('#SavedCategory').submit(function(event){
  ...
  $(":submit").attr("disabled", true);
    ...
    $("#edit_categoryDescription").val($(this).data('category_description'));
     $("#edit_url_slug").val($(this).data('url_slug'));
