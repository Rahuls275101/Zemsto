...
<form role="form" method="POST" action="<?php echo base_url('admin/edit_faq_process/'.$faqView->faq_id.''); ?>" enctype="multipart/form-data">
       ...
       <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <option value="Competitions & Olympiads" <?php if($faqView->type=='Competitions & Olympiads') { echo "selected"; } ?>>Competitions & Olympiads</option>
                    <option value="Registration & Fees" <?php if($faqView->type=='Registration & Fees') { echo "selected"; } ?>>Registration & Fees</option>
                     <option value="Delivery & Tracking" <?php if($faqView->type=='Delivery & Tracking') { echo "selected"; } ?>>Delivery & Tracking</option>
                    </select> 
                  </div>
                  </div>
                  <div class="col-md-6">
