      ...
      <div class="custom-file">
        ...
        <div class="image-box cat-thumb" onclick="triggerFileInput(event)">
          <img class="header-logo-preview"  src="<?php echo base_url('assets/img/'); ?>/<?php echo $addressView->footer_logo; ?>" alt="Header Logo" class="cat-thumb">
                  ...
                  <div class="col-md-4">
                  <div class="form-group">
                    <label for="exampleInputEmail1">Email Address Two</label>
                    <input type="text" class="form-control" name="email_two" value="<?php echo $addressView->email_two; ?>">
                  </div>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="col-md-4">
                  <div class="form-group">
                    <label for="exampleInputPassword1">Phone Tree</label>
                    <input type="text" class="form-control" name="phone_tree" value="<?php echo $addressView->phone_tree; ?>">
                  </div>
                  </div>
